...
# result = get_bestnetworks(r"C:\Users\User\Documents\GitHub\BL4201-SH-Project\RISData\Banjoreports\static.RISgrassreport.txt", 'static')
...
roughness = cyclic_rough + dag_rough
identifiers = list_of_string("cyclic", len(cyclic_rough)) + list_of_string("acyclic", len(dag_rough))
data["Roughness"] = roughness
data["id"] = identifiers
# Check it looks correct
print(data.head())
# Now save to a csv file
data.to_csv(f"{current_directory}/R/cyclicroughnessL5_total.csv")
