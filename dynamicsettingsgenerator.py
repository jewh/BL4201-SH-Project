...
shutil.copy2(template,
             f"{current_directory}/settings/allfiledynamicsettings.txt")
# This works
# now load the copy and edit it
fileout = open(f"{current_directory}/settings/allfiledynamicsettings.txt", 'w+')
for line in filein:
    fileout.write(line.replace("Positive control extinction network n6 L15 N4.0 I1000 in0",
        ...
        f"reportFile = dynamic.combinedsongbirdReport.txt"))
filein.close()
fileout.close()
