...
template = "C:/Users/User/Documents/Banjo/settings.txt"
...
for i in files:
    ...
    for line in filein:
        fileout.write(line.replace("Positive control extinction network n6 L15 N4.0 I1000 in0", remove_txt(i)).replace(
            ...
            "outputDirectory = {0}/BanjoOutputs".format(current_directory)).replace("reportFile = static.report.txt", "reportFile = static.{0}Report.txt".format(remove_txt(i))))
    fileout.close()
    filein.close()
